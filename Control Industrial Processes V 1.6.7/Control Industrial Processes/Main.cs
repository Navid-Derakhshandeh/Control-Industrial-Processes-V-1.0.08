...
namespace Control_Industrial_Processes
{
    public partial class Main : Form
    {
        ...
        private void designDrawToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DesignApp frm = new DesignApp();
            frm.Show();
        }

        private void workBenchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            WorkBenchToolKit frm = new WorkBenchToolKit();
            frm.Show();
        }

        private void dCMotorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MonitorDcMotor frm = new MonitorDcMotor();
            frm.Show();
        }

        private void conveyorBeltToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ConveyorbeltSpeed frm = new ConveyorbeltSpeed();
            frm.Show();
        }

        private void watertankToolStripMenuItem_Click(object sender, EventArgs e)
        {
            WaterTank frm = new WaterTank();
            frm.Show();
        }

        private void unit1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Electric_arc_furnace frm = new Electric_arc_furnace();
            frm.Show();
        }

        private void designWorkbenchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ModbusWorkbench frm = new ModbusWorkbench();
            frm.Show();
        }

        private void mach3MillToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _3AxisController frm = new _3AxisController();
            frm.Show();
        }

        private void waterTank1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            WaterTank2 frm = new WaterTank2();
            frm.Show();
        }

        private void hMIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            HMIPowerPlant frm = new HMIPowerPlant();
            frm.Show();
        }
    }
}
