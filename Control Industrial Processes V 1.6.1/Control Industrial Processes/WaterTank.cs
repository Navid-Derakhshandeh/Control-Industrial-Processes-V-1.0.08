...
namespace Control_Industrial_Processes
{
    public partial class WaterTank : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            SAT.Value = a.ToString();
            SAV.Value = b.ToString();
            SA1.Value = c.ToString();
            SAP.Value = d.ToString();
        ...
        private void btnStop_Click(object sender, EventArgs e)
        {
            ...
            picMR.Visible = true;
            picPR.Visible = true;
            SAT.Value = 0.ToString();
            SAV.Value = 0.ToString();
            SA1.Value = 0.ToString();
            SAP.Value = 0.ToString();
        }
    }
}
